...
//			'--key--' => array()
	...
	'BE' => array(		// Backend Configuration.
		...
		'lockSSL' => 0,							// Integer. 0,1,2,3: If set (1,2,3), the backend can only be operated from an ssl-encrypted connection (https). Set to 2 you will be redirected to the https admin-url supposed to be the http-url, but with https scheme instead. If set to 3, only the login is forced to SSL, then the user switches back to non-SSL-mode
...
//			'everybody' => ''					// default in tce_main is ''. If this is set (uncomment), this value is used instead.
	...
	'FE' => array(			// Configuration for the TypoScript frontend (FE). Nothing here relates to the administration backend!
		...
		'tidy' => FALSE,						// Boolean. If set, the output html-code will be passed through "tidy" which is a little program you can get from http://www.w3.org/People/Raggett/tidy/. "Tidy" cleans the HTML-code for nice display!
